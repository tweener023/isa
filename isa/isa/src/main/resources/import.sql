...
insert into users (username, email, password, first_name, last_name, address, city, zip_code, country, phone_number, jmbg, gender, job, workplace, points_collected, filled_questionnaire, account_verified) values ('saki','srdicognjen@gmail.com', '$2a$10$iwMIUYsBRR4n5dHJi7ZCUeeeDYgBqrt8dyVCUHvbKju6fKdI.Q2UC', 'Saki', 'Sakic', 'Kisacka 45', 'Novi Sad','21000', 'Srbija', '0656693696', 12342111, 1, 'student', 'FTN',1, false, true);
