...
insert into users (username, email, password, first_name, last_name, address, city, zip_code, country, phone_number, jmbg, gender, job, workplace, points_collected, filled_questionnaire, account_verified) values ('mare','marko@email.com', '$2a$10$iwMIUYsBRR4n5dHJi7ZCUeeeDYgBqrt8dyVCUHvbKju6fKdI.Q2UC', 'Marko', 'Marković', 'Kisacka 45', 'Novi Sad','21000', 'Srbija', '1234', 1234,0, 'student', 'FTN',11, true, false);
insert into users (username, email, password, first_name, last_name, address, city, zip_code, country, phone_number, jmbg, gender, job, workplace, points_collected, filled_questionnaire, account_verified) values ('saki','saki@email.com', '$2a$10$iwMIUYsBRR4n5dHJi7ZCUeeeDYgBqrt8dyVCUHvbKju6fKdI.Q2UC', 'Saki', 'Sakić', 'Kisacka 45', 'Novi Sad','21000', 'Srbija', '1233232', 123421, 1, 'student', 'FTN',1, false, false);
...
insert into users (username, email, password, first_name, last_name, address, city, zip_code, country, phone_number, jmbg, gender, job, workplace, points_collected, filled_questionnaire, account_verified) values ('zoki','zoki@email.com', '$2a$10$iwMIUYsBRR4n5dHJi7ZCUeeeDYgBqrt8dyVCUHvbKju6fKdI.Q2UC', 'Zoki', 'Jankov', 'Kisacka 45', 'Novi Sad','21000', 'Srbija', '1234', 1234983, 1, 'student', 'FTN',10, false, false);


--medic
insert into users (username, email, password, first_name, last_name, address, city, zip_code, country, phone_number, jmbg, gender, job, workplace, points_collected, filled_questionnaire, account_verified) values ('pera','pera@email.com', '$2a$10$iwMIUYsBRR4n5dHJi7ZCUeeeDYgBqrt8dyVCUHvbKju6fKdI.Q2UC', 'Pera', 'Peric', 'Kisacka 45', 'Novi Sad','21000', 'Srbija', '1234', 2431234, 1, 'student', 'FTN',4, false, false);
...
insert into appointments ( user_id, center_id, date_of_appointment, time_of_appointment) values (1,1, '2021-08-09', '10:30:00');
--insert into appointments ( user_id, center_id, date_of_appointment, time_of_appointment) values (null,1, '2021-08-09', '11:00:00');
--insert into appointments ( user_id, center_id, date_of_appointment, time_of_appointment) values (null,1, '2021-08-09', '11:30:00');
--insert into appointments ( user_id, center_id, date_of_appointment, time_of_appointment) values (null,1, '2021-08-09', '12:00:00');
